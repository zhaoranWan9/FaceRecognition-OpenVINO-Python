...
def face_recognition():
    ...
    frame = cv2.imread('../database/images/' + 'Leonardo4.jpg')
    ...
    if face_count > 1:
        ...
        try:
            ...
            cv2.putText(frame, 'Similarity:%.4f' % (similarity), (5, 25), cv2.FONT_HERSHEY_COMPLEX, 1,
                                    (0,0,255), 2)
            ...
            if similarity > 0.0:
                ...
                cv2.imwrite('Leonardo4 vs Leonardo1.jpg', frame)
                cv2.waitKey(-1)
